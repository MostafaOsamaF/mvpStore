          ...
          <div className="container mx-auto px-4 max-w-7xl">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold mb-6 text-balance">رسالة Nexora</h2>
                <p className="text-lg text-muted-foreground leading-relaxed mb-6 text-pretty">
                  تلتزم Nexora المصرية بدعم الإبداع المحلي والفن الأصيل من خلال توفير منصة متميزة لعرض وتسويق
